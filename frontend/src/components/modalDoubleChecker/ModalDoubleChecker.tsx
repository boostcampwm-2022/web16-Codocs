...
const ModalDoubleChecker = ({
  ...
  if (modalType === 'INIT') {
    ...
    return (
      <ModalContent>
        <Question>
          <QuestionTitle>{checkerByType[modalType].questionTitle}</QuestionTitle>
          <QuestionDescription>{checkerByType[modalType].questionDescription}</QuestionDescription>
        </Question>
        <Answers>
